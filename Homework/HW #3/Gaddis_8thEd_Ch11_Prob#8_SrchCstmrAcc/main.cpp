 ...
 * Purpose: Customer Account Information and Corrections and Searching
 */
...
int main(int argc, char** argv){
    ...
    do{
        ...
        cout<<"Type 3 to make any corrections to Customer Information."<<endl;
        cout<<"Type 4 to Search Array for Certain Customer."<<endl<<endl;
...
void srch(info *a, int size){

string srch;
        cout<<"Enter a Name you wish to look for in the Structure."<<endl;
        getline(cin,srch);
        for(int i=0;i<size;i++){
            if(!(a[i].name.compare(srch)==0)){
                cout<<"Entry "<<i+1<<" Name Not Found."<<endl;
            }
            else cout<<"Entry "<<i+1<<" Name Found."<<endl;
        }
}